  ...
  import { ConfirmBid } from './pages/ConfirmBid.jsx'; // Import ConfirmationPage
  import { PaymentDashboard } from './pages/PaymentDashboard';

  // import { ConfirmationPage } from './pages/ConfirmationPage.jsx';

  //The SocketProvider wraps your application (or part of it) so that any 
  // component can access the socket using the useSocket hook.
  export const App = () => (
    <SocketProvider>
      <Router>
        <Routes>
          ...
          <Route element={<>
            ...
            <Route element={<PrivateRoute allowedRoles={['client']} />}>
              ...
              <Route path="/confirmbid/:projectId/:freelancerId/:bidId" element={<ConfirmBid />} /> 
              {/* <Route path="/confirmation/:projectId/:freelancerId" element={<ConfirmationPage />} /> */}
            </Route> 
            ...
            {/* Shared routes */}
            <Route path="/client-profile" element={<ClientProfile />} />
            <Route path="/freelancer-message/:id" element={<FreelancerProfileView />} />
